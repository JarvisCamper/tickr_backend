...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles_build'  # For Vercel: collects to this dir during build

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Optional: If you have custom static files outside apps (e.g., project-level static/)
