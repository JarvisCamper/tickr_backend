...
# Database
# Default is Postgres (Aiven/Vercel w/ SSL). For local development you can set:
#   USE_SQLITE=True
...
# HTTPS/session hardening (can be overridden by environment variables)
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'tickr.exceptions.custom_exception_handler',
}
